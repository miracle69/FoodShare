...
const a_editor = new E('#a_zf')
a_editor.create()

const E1 = window.wangEditor
const e_editor = new E1('#e_zf')
e_editor.create()
...
$(document).ready(function(e) {
    ...
    var doMethod = {
        ...
        save:function(){
            ...
            formParamObj.zf = a_editor.txt.html();
                //验证通过
                $.ajax({
                    url: "/food/addFood",
                    async: false,
        ...
        editSave:function(){
            ...
            formParamObj.zf = e_editor.txt.html();
            //验证通过
            $.ajax({
